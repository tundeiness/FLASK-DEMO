...
from application.models import TravelPermit
from application import db 



travel_permit_blueprint = Blueprint(
    'travel_permit',
    __name__,
...
@travel_permit_blueprint.route('/travel-permit', methods=['POST'])
...
@travel_permit_blueprint.route('/travel-permit', methods=['GET'])
...
@travel_permit_blueprint.route('/travel-permit/<id_>', methods=['GET'])
...
@travel_permit_blueprint.route('/travel-permit/<id_>', methods=['PUT'])
...
@travel_permit_blueprint.route('/travel-permit/<id_>', methods=['DELETE'])
